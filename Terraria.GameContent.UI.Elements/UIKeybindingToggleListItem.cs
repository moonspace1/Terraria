...
public class UIKeybindingToggleListItem : UIElement
{
	...
	protected override void DrawSelf(SpriteBatch spriteBatch)
	{
		...
		spriteBatch.Draw(position: new Vector2(dimensions.X + dimensions.Width - vector2.X - 10f, dimensions.Y + 2f + num), texture: _toggleTexture.Value, sourceRectangle: value2, color: Color.White, rotation: 0f, origin: Vector2.Zero, scale: Vector2.One, effects: SpriteEffects.None, layerDepth: 0f);
	}
}
