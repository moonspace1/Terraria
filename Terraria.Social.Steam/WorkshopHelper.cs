...
public class WorkshopHelper
{
	public class UGCBased
	{
		...
		public abstract class APublisherInstance
		{
			...
			{
				return publicityId switch
				{
					WorkshopItemPublicSettingId.FriendsOnly => ERemoteStoragePublishedFileVisibility.k_ERemoteStoragePublishedFileVisibilityFriendsOnly, 
					WorkshopItemPublicSettingId.Public => ERemoteStoragePublishedFileVisibility.k_ERemoteStoragePublishedFileVisibilityPublic, 
