...
public class LanguageManager
{
    ...
    public readonly Dictionary<string, LocalizedText> _localizedTexts = new Dictionary<string, LocalizedText>();

    public readonly Dictionary<string, List<string>> _categoryGroupedKeys = new Dictionary<string, List<string>>();

    public GameCulture _fallbackCulture = GameCulture.DefaultCulture;

    public GameCulture ActiveCulture { get; set; }
    ...
    public void SetAllTextValuesToKeys()
    {
    ...
    public string[] GetLanguageFilesForCulture(GameCulture culture)
    {
        return new string[7]
        {
            "Terraria.Localization.Content." + culture.CultureInfo.Name + ".Game.json",
            "Terraria.Localization.Content." + culture.CultureInfo.Name + ".Items.json",
            "Terraria.Localization.Content." + culture.CultureInfo.Name + ".json",
            "Terraria.Localization.Content." + culture.CultureInfo.Name + ".Legacy.json",
            "Terraria.Localization.Content." + culture.CultureInfo.Name + ".NPCs.json",
            "Terraria.Localization.Content." + culture.CultureInfo.Name + ".Projectiles.json",
            "Terraria.Localization.Content." + culture.CultureInfo.Name + ".Town.json"
        };
    }
    ...
    public void LoadLanguage(GameCulture culture, bool processCopyCommands = true)
    {
    ...
    public void LoadFilesForCulture(GameCulture culture)
    {
    ...
    public void ProcessCopyCommandsInTexts()
    {
    ...
    [Conditional("DEBUG")]
    public void ValidateAllCharactersContainedInFont(DynamicSpriteFont font)
    {
        if (font == null)
        {
            return;
