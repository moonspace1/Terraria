...
public class DunesBiome : MicroBiome
{
	...
	private static void PlaceCurvedLine(Point startPoint, Point endPoint, Point anchorOffset, DunesDescription description)
	{
		...
		{
			Vector2D value3 = Vector2D.Lerp(value, vector2D, num2);
			Vector2D value4 = Vector2D.Lerp(vector2D, value2, num2);
			Point point2 = Vector2D.Lerp(value3, value4, num2).ToPoint();
			if (point2 == point)
			{
				continue;
			}
