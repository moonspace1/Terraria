...
public static class PlayerDrawLayers
{
	...
	public static void DrawPlayer_09_Wings(ref PlayerDrawSet drawinfo)
	{
		...
		if (drawinfo.drawPlayer.wings == 43 && drawinfo.shadow == 0f)
		{
			...
			for (int l = 0; l < 2; l++)
			{
				item = new DrawData(position: vector13 + new Vector2((float)Main.rand.Next(-10, 10) * 0.125f, (float)Main.rand.Next(-10, 10) * 0.125f), texture: TextureAssets.GlowMask[272].Value, sourceRect: value5, color: new Color(230, 230, 230, 60), rotation: drawinfo.drawPlayer.bodyRotation, origin: origin, scale: 1f, effect: drawinfo.playerEffect);
				item.shader = drawinfo.cWings;
				drawinfo.DrawDataCache.Add(item);
			}
		}
		...
		{
			item = new DrawData(TextureAssets.GlowMask[181].Value, vector12.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), new Color(255, 255, 255, 127) * drawinfo.stealth * (1f - drawinfo.shadow), drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1f, drawinfo.playerEffect);
			item.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(item);
		}
		else if (drawinfo.drawPlayer.wings == 38)
		{
			...
			item = new DrawData(TextureAssets.GlowMask[251].Value, vector12.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), color9, drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1f, drawinfo.playerEffect);
			item.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(item);
		...
		{
			item = new DrawData(TextureAssets.GlowMask[183].Value, vector12.Floor(), new Rectangle(0, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4 * drawinfo.drawPlayer.wingFrame, TextureAssets.Wings[drawinfo.drawPlayer.wings].Width(), TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 4), new Color(255, 255, 255, 0) * drawinfo.stealth * (1f - drawinfo.shadow), drawinfo.drawPlayer.bodyRotation, new Vector2(TextureAssets.Wings[drawinfo.drawPlayer.wings].Width() / 2, TextureAssets.Wings[drawinfo.drawPlayer.wings].Height() / 8), 1.06f, drawinfo.playerEffect);
			item.shader = drawinfo.cWings;
			drawinfo.DrawDataCache.Add(item);
		}
	}
	...
	public static void DrawPlayer_21_Head(ref PlayerDrawSet drawinfo)
	{
		...
		{
			DrawData item = new DrawData(TextureAssets.PlayerHairAlt[drawinfo.drawPlayer.hair].Value, position, drawinfo.hairFrontFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
			item.shader = drawinfo.hairDyePacked;
			drawinfo.DrawDataCache.Add(item);
		}
		...
		else if (drawinfo.drawPlayer.head == 259)
		{
			...
			if (!drawinfo.drawPlayer.invis)
			{
				DrawData item = new DrawData(TextureAssets.PlayerHair[drawinfo.drawPlayer.hair].Value, position, drawinfo.hairFrontFrame, drawinfo.colorHair, drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
				item.shader = drawinfo.hairDyePacked;
				drawinfo.DrawDataCache.Add(item);
			}
		}
		...
		{
			DrawData item = new DrawData(TextureAssets.JackHat.Value, helmetOffset + new Vector2((int)(drawinfo.Position.X - Main.screenPosition.X - (float)(drawinfo.drawPlayer.bodyFrame.Width / 2) + (float)(drawinfo.drawPlayer.width / 2)), (int)(drawinfo.Position.Y - Main.screenPosition.Y + (float)drawinfo.drawPlayer.height - (float)drawinfo.drawPlayer.bodyFrame.Height + 4f)) + drawinfo.drawPlayer.headPosition + drawinfo.headVect, drawinfo.drawPlayer.bodyFrame, new Color(255, 255, 255, 255), drawinfo.drawPlayer.headRotation, drawinfo.headVect, 1f, drawinfo.playerEffect);
			drawinfo.DrawDataCache.Add(item);
			for (int l = 0; l < 7; l++)
			{
		...
		try
		{
			...
			if (TextureAssets.ItemFlame[num].IsLoaded)
			{
				...
				for (int i = 0; i < num15; i++)
				{
					...
					item = new DrawData(TextureAssets.ItemFlame[num].Value, new Vector2((int)(position.X + num18 + num17), (int)(position.Y + num19)), itemDrawFrame, color4, num5, origin, adjustedItemScale, drawinfo.itemEffect);
					drawinfo.DrawDataCache.Add(item);
				}
			}
		}
	...
	public static void DrawPlayer_30_BladedGlove(ref PlayerDrawSet drawinfo)
	{
		...
		if (!drawinfo.drawPlayer.frozen && (drawinfo.drawPlayer.itemAnimation > 0 || (heldItem.holdStyle != 0 && !drawinfo.drawPlayer.pulley)) && heldItem.type > 0 && !drawinfo.drawPlayer.dead && !heldItem.noUseGraphic && (!drawinfo.drawPlayer.wet || !heldItem.noWet))
		{
			...
			{
				DrawData item = new DrawData(asset.Value, new Vector2((int)(drawinfo.ItemLocation.X - Main.screenPosition.X), (int)(drawinfo.ItemLocation.Y - Main.screenPosition.Y)), new Rectangle(0, 0, asset.Width(), asset.Height()), heldItem.GetAlpha(drawinfo.itemColor), drawinfo.drawPlayer.itemRotation, new Vector2((float)asset.Width() * 0.5f - (float)asset.Width() * 0.5f * (float)drawinfo.drawPlayer.direction, asset.Height()), drawinfo.drawPlayer.GetAdjustedItemScale(heldItem), drawinfo.itemEffect);
				drawinfo.DrawDataCache.Add(item);
			}
		}
	}
