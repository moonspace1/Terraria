...
public class Lang
{
	...
	public static void InitializeLegacyLocalization()
	{
		...
		ItemTooltip.AddGlobalProcessor(SupportGlyphs);
	...
	public static void BuildMapAtlas()
	{
		...
		_mapLegendCache[MapHelper.TileToLookup(89, 1)] = _itemNameCache[2397];
		_mapLegendCache[MapHelper.TileToLookup(89, 2)] = _itemNameCache[4993];
