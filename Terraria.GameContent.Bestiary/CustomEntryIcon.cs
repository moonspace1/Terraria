...
public class CustomEntryIcon : IEntryIcon
{
	...
	public void Draw(BestiaryUICollectionInfo providedInfo, SpriteBatch spriteBatch, EntryIconDrawSettings settings)
	{
		...
		spriteBatch.Draw(_textureAsset.Value, iconbox.Center.ToVector2() + Vector2.One, _sourceRectangle, Color.White, 0f, _sourceRectangle.Size() / 2f, 1f, SpriteEffects.None, 0f);
	}
