		...
		try
		{
			...
			if (flag)
			{
				...
				case 0:
				{
					...
					SoundInstanceDig[num16] = SoundDig[num16].Value.CreateInstance();
				...
				case 43:
				{
					...
					SoundInstanceThunder[num15] = SoundThunder[num15].Value.CreateInstance();
				...
				case 63:
				{
					...
					SoundInstanceResearch[num17] = SoundResearch[num17].Value.CreateInstance();
				...
				case 1:
				{
					...
					SoundInstancePlayerHit[num18] = SoundPlayerHit[num18].Value.CreateInstance();
				...
				case 14:
					...
					{
						int num24 = 7;
						SoundInstanceZombie[num24] = SoundZombie[num24].Value.CreateInstance();
					...
					case 586:
					{
						...
						SoundInstanceZombie[num23] = SoundZombie[num23].Value.CreateInstance();
				...
				case 20:
				{
					...
					SoundInstanceFemaleHit[num25] = SoundFemaleHit[num25].Value.CreateInstance();
				...
				case 21:
				{
					...
					SoundInstanceTink[num20] = SoundTink[num20].Value.CreateInstance();
				...
				default:
					...
					default:
						...
						case 36:
						{
							...
							SoundInstanceRoar[num11] = SoundRoar[num11].Value.CreateInstance();
						...
						case 37:
						{
							...
							SoundInstanceItem[num9] = SoundItem[num9].Value.CreateInstance();
						...
						case 38:
						{
							...
							SoundInstanceCoin[num13] = SoundCoin[num13].Value.CreateInstance();
						...
						case 65:
						{
							...
							SoundInstanceZombie[num8] = SoundZombie[num8].Value.CreateInstance();
