...
public static class ChatHelper
{
	...
	{
		DisplayMessageOnClient(text, color.R, color.G, color.B, playerId);
    ...
    // Added because hook cant requires byte values for Color
    public static void DisplayMessageOnClient(NetworkText text, byte R, byte G, byte B, int playerId)
    {
