...
public class UICharacterCreation : UIState
{
	...
	private void MakeCategoriesBar(UIElement categoryContainer)
	{
		...
		_clothingStylesCategoryButton.SetSnapPoint("Top", 1, null, null);
		...
		_hairStylesCategoryButton.SetSnapPoint("Top", 2, null, null);
		...
		_charInfoCategoryButton.SetSnapPoint("Top", 0, null, null);
