	...
	private void CreateElementGroup(UIList parent, List<string> bindings, InputMode currentInputMode, Color color)
	{
		for (int i = 0; i < bindings.Count; i++)
		{
			...
			if (_BindingsHalfSingleLine.Contains(bindings[i]))
			{
				...
				uIElement.SetSnapPoint("Wide", SnapPointIndex++, null, null);
			...
			if (_BindingsFullLine.Contains(bindings[i]))
			{
				...
				uIElement2.SetSnapPoint("Wide", SnapPointIndex++, null, null);
			...
			uIElement3.SetSnapPoint("Thin", SnapPointIndex++, null, null);
	...
	public UIElement CreatePanel(string bind, InputMode currentInputMode, Color color)
	{
		...
		case "sp11":
		{
			...
			uIKeybindingSimpleListItem2.OnLeftClick += delegate
			{
				...
				PlayerInput.CurrentProfile.CopyMapSettingsFrom(PlayerInput.OriginalProfiles[copyableProfileName2], currentInputMode);
			};
		...
		case "sp13":
		{
			...
			uIKeybindingSimpleListItem4.OnLeftClick += delegate
			{
				...
				PlayerInput.CurrentProfile.CopyGamepadAdvancedSettingsFrom(PlayerInput.OriginalProfiles[copyableProfileName4], currentInputMode);
			};
