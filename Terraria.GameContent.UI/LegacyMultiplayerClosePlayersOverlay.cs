...
public class LegacyMultiplayerClosePlayersOverlay : IMultiplayerClosePlayersOverlay
{
	...
	{
		float scale = 0.85f;
		spriteBatch.DrawString(FontAssets.MouseText.Value, npDist, new Vector2(npDistPos.X - 2f, npDistPos.Y), Color.Black, 0f, default(Vector2), scale, SpriteEffects.None, 0f);
		spriteBatch.DrawString(FontAssets.MouseText.Value, npDist, new Vector2(npDistPos.X + 2f, npDistPos.Y), Color.Black, 0f, default(Vector2), scale, SpriteEffects.None, 0f);
		spriteBatch.DrawString(FontAssets.MouseText.Value, npDist, new Vector2(npDistPos.X, npDistPos.Y - 2f), Color.Black, 0f, default(Vector2), scale, SpriteEffects.None, 0f);
		spriteBatch.DrawString(FontAssets.MouseText.Value, npDist, new Vector2(npDistPos.X, npDistPos.Y + 2f), Color.Black, 0f, default(Vector2), scale, SpriteEffects.None, 0f);
		spriteBatch.DrawString(FontAssets.MouseText.Value, npDist, npDistPos, namePlateColor, 0f, default(Vector2), scale, SpriteEffects.None, 0f);
	}
	...
	{
		spriteBatch.DrawString(FontAssets.MouseText.Value, namePlate, new Vector2(namePlatePos.X - 2f, namePlatePos.Y), Color.Black, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
		spriteBatch.DrawString(FontAssets.MouseText.Value, namePlate, new Vector2(namePlatePos.X + 2f, namePlatePos.Y), Color.Black, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
		spriteBatch.DrawString(FontAssets.MouseText.Value, namePlate, new Vector2(namePlatePos.X, namePlatePos.Y - 2f), Color.Black, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
		spriteBatch.DrawString(FontAssets.MouseText.Value, namePlate, new Vector2(namePlatePos.X, namePlatePos.Y + 2f), Color.Black, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
		spriteBatch.DrawString(FontAssets.MouseText.Value, namePlate, namePlatePos, namePlateColor, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
	}
}
