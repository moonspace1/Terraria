...
public class NewMultiplayerClosePlayersOverlay : IMultiplayerClosePlayersOverlay
{
	private struct PlayerOnScreenCache
	{
		...
		{
			_pos = _pos.Floor();
			spriteBatch.DrawString(FontAssets.MouseText.Value, _name, new Vector2(_pos.X - 2f, _pos.Y), Color.Black, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
			spriteBatch.DrawString(FontAssets.MouseText.Value, _name, new Vector2(_pos.X + 2f, _pos.Y), Color.Black, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
			spriteBatch.DrawString(FontAssets.MouseText.Value, _name, new Vector2(_pos.X, _pos.Y - 2f), Color.Black, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
			spriteBatch.DrawString(FontAssets.MouseText.Value, _name, new Vector2(_pos.X, _pos.Y + 2f), Color.Black, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
			spriteBatch.DrawString(FontAssets.MouseText.Value, _name, _pos, _color, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
		}
	}
	...
	private struct PlayerOffScreenCache
	{
		...
		{
			float scale = 0.85f;
			spriteBatch.DrawString(FontAssets.MouseText.Value, distanceString, new Vector2(distanceDrawPosition.X - 2f, distanceDrawPosition.Y), Color.Black, 0f, default(Vector2), scale, SpriteEffects.None, 0f);
			spriteBatch.DrawString(FontAssets.MouseText.Value, distanceString, new Vector2(distanceDrawPosition.X + 2f, distanceDrawPosition.Y), Color.Black, 0f, default(Vector2), scale, SpriteEffects.None, 0f);
			spriteBatch.DrawString(FontAssets.MouseText.Value, distanceString, new Vector2(distanceDrawPosition.X, distanceDrawPosition.Y - 2f), Color.Black, 0f, default(Vector2), scale, SpriteEffects.None, 0f);
			spriteBatch.DrawString(FontAssets.MouseText.Value, distanceString, new Vector2(distanceDrawPosition.X, distanceDrawPosition.Y + 2f), Color.Black, 0f, default(Vector2), scale, SpriteEffects.None, 0f);
			spriteBatch.DrawString(FontAssets.MouseText.Value, distanceString, distanceDrawPosition, namePlateColor, 0f, default(Vector2), scale, SpriteEffects.None, 0f);
		}
	}
