	...
	private static void LoadLegacyHairdyes()
	{
		...
		GameShaders.Hair.BindShader(1980, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			if ((float)num16 < num17)
			{
				...
				newColor.R = (byte)((float)(int)color.R * num21 + (float)(int)color2.R * num20);
				newColor.G = (byte)((float)(int)color.G * num21 + (float)(int)color2.G * num20);
				newColor.B = (byte)((float)(int)color.B * num21 + (float)(int)color2.B * num20);
			}
			else if ((float)num16 < num18)
			{
				...
				newColor.R = (byte)((float)(int)color2.R * num24 + (float)(int)color3.R * num23);
				newColor.G = (byte)((float)(int)color2.G * num24 + (float)(int)color3.G * num23);
				newColor.B = (byte)((float)(int)color2.B * num24 + (float)(int)color3.B * num23);
			}
			else if ((float)num16 < num19)
			{
				...
				newColor.R = (byte)((float)(int)color3.R * num27 + (float)(int)color4.R * num26);
				newColor.G = (byte)((float)(int)color3.G * num27 + (float)(int)color4.G * num26);
				newColor.B = (byte)((float)(int)color3.B * num27 + (float)(int)color4.B * num26);
			}
			else
			{
				newColor = color4;
		...
		GameShaders.Hair.BindShader(1981, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			if (Main.dayTime)
			{
				if (Main.time < 27000.0)
				{
					...
					newColor.R = (byte)((float)(int)color5.R * num29 + (float)(int)color6.R * num28);
					newColor.G = (byte)((float)(int)color5.G * num29 + (float)(int)color6.G * num28);
					newColor.B = (byte)((float)(int)color5.B * num29 + (float)(int)color6.B * num28);
				}
				else
				{
					float num30 = 27000f;
					...
					newColor.R = (byte)((float)(int)color6.R * num32 + (float)(int)color7.R * num31);
					newColor.G = (byte)((float)(int)color6.G * num32 + (float)(int)color7.G * num31);
					newColor.B = (byte)((float)(int)color6.B * num32 + (float)(int)color7.B * num31);
				}
			}
			else if (Main.time < 16200.0)
			{
				...
				newColor.R = (byte)((float)(int)color7.R * num34 + (float)(int)color8.R * num33);
				newColor.G = (byte)((float)(int)color7.G * num34 + (float)(int)color8.G * num33);
				newColor.B = (byte)((float)(int)color7.B * num34 + (float)(int)color8.B * num33);
			}
			else
			{
				float num35 = 16200f;
				...
				newColor.R = (byte)((float)(int)color8.R * num37 + (float)(int)color5.R * num36);
				newColor.G = (byte)((float)(int)color8.G * num37 + (float)(int)color5.G * num36);
				newColor.B = (byte)((float)(int)color8.B * num37 + (float)(int)color5.B * num36);
			}
			return newColor;
		}));
		...
		GameShaders.Hair.BindShader(1983, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			{
				color9 = ((Main.waterStyle == 2) ? new Color(124, 118, 242) : ((Main.waterStyle == 3) ? new Color(143, 215, 29) : ((Main.waterStyle == 4) ? new Color(78, 193, 227) : ((Main.waterStyle == 5) ? new Color(189, 231, 255) : ((Main.waterStyle == 6) ? new Color(230, 219, 100) : ((Main.waterStyle == 7) ? new Color(151, 107, 75) : ((Main.waterStyle == 8) ? new Color(128, 128, 128) : ((Main.waterStyle == 9) ? new Color(200, 0, 0) : ((Main.waterStyle == 10) ? new Color(208, 80, 80) : ((Main.waterStyle == 12) ? new Color(230, 219, 100) : ((Main.waterStyle != 13) ? new Color(28, 216, 94) : new Color(28, 216, 94))))))))))));
			}
			else
			{
		...
		GameShaders.Hair.BindShader(1986, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			newColor.R = (byte)(75f * num40 + (float)(int)player.hairColor.R * num41);
			newColor.G = (byte)(255f * num40 + (float)(int)player.hairColor.G * num41);
			newColor.B = (byte)(200f * num40 + (float)(int)player.hairColor.B * num41);
			return newColor;
		}));
		GameShaders.Hair.BindShader(2863, new LegacyHairShaderData().UseLegacyMethod(delegate(Player player, Color newColor, ref bool lighting)
		{
			...
			Color color11 = Lighting.GetColor(x, y);
