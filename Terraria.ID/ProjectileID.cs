...
public class ProjectileID
{
	public static class Sets
	{
		...
		public static SettingsForCharacterPreview[] CharacterPreviewAnimations = Factory.CreateCustomSet(new SettingsForCharacterPreview(), (short)111, SimpleLoop(0, 6).WithOffset(6f, 0f).WhenNotSelected(0, 0, null, null).WithSpriteDirection(-1), (short)112, SimpleLoop(0, 3, 5).WhenNotSelected(0, 0, null, null).WithSpriteDirection(-1), (short)127, SimpleLoop(0, 5).WhenNotSelected(0, 0, null, null).WithOffset(-6f, 0f).WithSpriteDirection(-1), (short)175, SimpleLoop(0, 2, 8).WhenNotSelected(0, 2, 10, null).WithOffset(-4f, -6f).WithCode(DelegateMethods.CharacterPreview.Float), (short)197, SimpleLoop(0, 0).WithOffset(-8f, -4f).WithCode(DelegateMethods.CharacterPreview.FloatAndSpinWhenWalking), (short)198, SimpleLoop(0, 4).WhenNotSelected(0, 4, 4, null).WithOffset(-8f, -20f).WithSpriteDirection(-1)
			.WithCode(DelegateMethods.CharacterPreview.Float), (short)199, SimpleLoop(0, 8, 6).WhenNotSelected(0, 8, 6, null).WithOffset(-2f, -18f).WithCode(DelegateMethods.CharacterPreview.Float), (short)200, SimpleLoop(0, 6, 5).WhenNotSelected(0, 0, null, null).WithOffset(-2f, 0f).WithSpriteDirection(-1), (short)208, SimpleLoop(1, 4, 5).WhenNotSelected(1, 4, 7, null).WithOffset(-2f, -12f).WithSpriteDirection(-1)
			.WithCode(DelegateMethods.CharacterPreview.Float), (short)209, SimpleLoop(2, 10, 5).WhenNotSelected(0, 0, null, null).WithOffset(6f, 0f).WithSpriteDirection(-1), (short)210, SimpleLoop(1, 6, 6).WhenNotSelected(0, 0, null, null).WithOffset(4f, 0f).WithSpriteDirection(-1), (short)236, SimpleLoop(2, 7, 5).WhenNotSelected(0, 0, null, null).WithOffset(-16f, 0f).WithSpriteDirection(-1), (short)268, SimpleLoop(0, 6, 6).WhenNotSelected(0, 0, null, null).WithOffset(4f, 0f).WithSpriteDirection(-1), (short)269, SimpleLoop(0, 4, 6).WhenNotSelected(0, 0, null, null).WithOffset(0f, 0f).WithSpriteDirection(-1), (short)313, SimpleLoop(0, 4, 5).WhenNotSelected(0, 0, null, null).WithOffset(-6f, 0f).WithSpriteDirection(-1), (short)314, SimpleLoop(1, 6, 5).WhenNotSelected(0, 0, null, null).WithOffset(-4f, 0f).WithSpriteDirection(-1), (short)319, SimpleLoop(2, 4, 6).WhenNotSelected(0, 0, null, null).WithOffset(-14f, 0f).WithSpriteDirection(-1), (short)324, SimpleLoop(2, 4, 6).WhenNotSelected(0, 0, null, null).WithOffset(-4f, 0f).WithSpriteDirection(-1), (short)334, SimpleLoop(2, 5, 5).WhenNotSelected(0, 0, null, null).WithOffset(-10f, 0f).WithSpriteDirection(-1), (short)353, SimpleLoop(2, 8, 6).WhenNotSelected(0, 0, null, null).WithOffset(4f, 0f).WithSpriteDirection(-1), (short)380, SimpleLoop(0, 4, 6).WithOffset(-10f, -20f).WithSpriteDirection(-1).WithCode(DelegateMethods.CharacterPreview.Float), (short)398, SimpleLoop(1, 5, 7).WhenNotSelected(0, 0, null, null).WithOffset(6f, 0f), (short)499, SimpleLoop(2, 6, 7).WhenNotSelected(0, 0, null, null).WithOffset(-18f, 0f).WithSpriteDirection(-1), (short)653, SimpleLoop(0, 0).WithOffset(-2f, 0f).WithCode(DelegateMethods.CharacterPreview.CompanionCubePet), (short)703, SimpleLoop(0, 4).WhenNotSelected(0, 4, 4, null).WithOffset(4f, -10f).WithCode(DelegateMethods.CharacterPreview.Float), (short)701, SimpleLoop(0, 3, 6).WhenNotSelected(0, 3, 6, null).WithOffset(-2f, -18f).WithCode(DelegateMethods.CharacterPreview.Float), (short)764, SimpleLoop(0, 0).WithOffset(2f, -18f).WithCode(DelegateMethods.CharacterPreview.EtsyPet), (short)765, SimpleLoop(2, 4, 6).WhenNotSelected(0, 0, null, null).WithOffset(-4f, 0f).WithSpriteDirection(-1), (short)774, SimpleLoop(4, 4, 6).WithOffset(-14f, -24f).WithSpriteDirection(-1).WithCode(DelegateMethods.CharacterPreview.Float), (short)825, SimpleLoop(14, 6, 6).WhenNotSelected(0, 0, null, null).WithOffset(-6f, 0f).WithSpriteDirection(-1), (short)821, SimpleLoop(13, 6, 6).WhenNotSelected(0, 0, null, null).WithOffset(0f, 0f).WithSpriteDirection(-1), (short)815, SimpleLoop(0, 6, 6).WhenNotSelected(0, 6, 6, null).WithOffset(-20f, -30f).WithSpriteDirection(-1)
			.WithCode(DelegateMethods.CharacterPreview.Float), (short)816, SimpleLoop(4, 7, 6).WhenNotSelected(0, 0, null, null).WithOffset(-10f, 0f).WithSpriteDirection(-1), (short)817, SimpleLoop(0, 3, 6, bounceLoop: true).WithSpriteDirection(-1).WithOffset(-6f, -12f).WithCode(DelegateMethods.CharacterPreview.Float), (short)854, SimpleLoop(0, 4, 6).WithOffset(6f, 0f).WithSpriteDirection(-1).WhenSelected(4, 9, 4, null), (short)858, SimpleLoop(0, 1).WithOffset(-6f, 0f).WithSpriteDirection(-1).WhenSelected(2, 8, 4, null), (short)859, SimpleLoop(0, 1).WithOffset(4f, 0f).WithSpriteDirection(-1).WhenSelected(5, 13, 3, null), (short)860, SimpleLoop(0, 1).WithOffset(2f, 0f).WithSpriteDirection(-1).WhenSelected(5, 1, null, null), (short)875, SimpleLoop(0, 1).WithOffset(4f, 0f).WithSpriteDirection(-1).WhenSelected(0, 7, 4, null), (short)881, SimpleLoop(0, 1).WhenSelected(1, 5, 6, null).WithCode(DelegateMethods.CharacterPreview.SlimePet), (short)882, SimpleLoop(0, 6, 5).WithOffset(4f, -16f).WithCode(DelegateMethods.CharacterPreview.Float), (short)883, SimpleLoop(0, 1).WithOffset(2f, -8f).WithCode(DelegateMethods.CharacterPreview.WormPet), (short)884, SimpleLoop(0, 1).WhenSelected(2, 7, 5, null), (short)885, SimpleLoop(0, 5, 5).WithOffset(4f, -16f).WithCode(DelegateMethods.CharacterPreview.FloatAndSpinWhenWalking), (short)886, SimpleLoop(0, 8).WithOffset(4f, -16f).WithSpriteDirection(-1).WithCode(DelegateMethods.CharacterPreview.Float), (short)887, SimpleLoop(0, 1).WithOffset(2f, -8f).WithCode(DelegateMethods.CharacterPreview.WormPet), (short)888, SimpleLoop(0, 6, 5).WithOffset(4f, -16f).WithCode(DelegateMethods.CharacterPreview.Float), (short)889, SimpleLoop(0, 5, 5).WithOffset(4f, -16f).WithCode(DelegateMethods.CharacterPreview.FloatAndSpinWhenWalking), (short)890, SimpleLoop(0, 1).WithOffset(2f, 0f).WhenSelected(2, 6, 5, null), (short)892, SimpleLoop(0, 6, 6).WithOffset(-4f, -12f).WithSpriteDirection(-1).WithCode(DelegateMethods.CharacterPreview.Float), (short)893, SimpleLoop(0, 1).WithOffset(0f, -8f).WithCode(DelegateMethods.CharacterPreview.WormPet), (short)894, SimpleLoop(0, 8).WithOffset(-2f, -12f).WithSpriteDirection(-1).WithCode(DelegateMethods.CharacterPreview.Float), (short)897, SimpleLoop(0, 1).WithOffset(2f, 0f).WhenSelected(2, 6, 5, null), (short)898, SimpleLoop(0, 16, 5).WithOffset(-2f, -16f), (short)899, SimpleLoop(0, 1).WithOffset(2f, 0f).WhenSelected(2, 7, 4, null), (short)900, SimpleLoop(0, 1).WithOffset(6f, 0f).WhenSelected(2, 7, 4, null), (short)901, SimpleLoop(0, 5).WithOffset(-2f, -12f).WithSpriteDirection(-1).WithCode(DelegateMethods.CharacterPreview.Float), (short)934, SimpleLoop(0, 1).WhenSelected(1, 5, 5, null).WithCode(DelegateMethods.CharacterPreview.SlimePet), (short)956, SimpleLoop(0, 1).WithOffset(0f, 0f).WhenSelected(1, 8, 4, null).WithCode(DelegateMethods.CharacterPreview.BerniePet), (short)957, SimpleLoop(0, 24, 3).WithOffset(0f, -14f).WithCode(DelegateMethods.CharacterPreview.Float), (short)958, SimpleLoop(0, 1).WithOffset(-2f, 0f).WhenSelected(5, 8, 4, null), (short)959, SimpleLoop(0, 1).WhenSelected(1, 7, 4, null).WithOffset(4f, 0f), (short)960, SimpleLoop(0, 4).WithOffset(4f, 0f).WhenSelected(5, 7, 4, null), (short)994, SimpleLoop(0, 4, 5).WithOffset(2f, 0f).WhenSelected(5, 7, 5, null), (short)998, SimpleLoop(0, 1).WithOffset(6f, 0f).WithSpriteDirection(-1).WhenSelected(0, 6, 5, null), (short)1003, SimpleLoop(0, 1).WithOffset(2f, 0f).WithSpriteDirection(-1).WhenSelected(2, 9, 4, null), (short)1004, SimpleLoop(0, 1).WithOffset(-2f, 0f).WithSpriteDirection(-1).WhenSelected(2, 7, 4, null), (short)1018, SimpleLoop(0, 0).WithOffset(8f, 0f).WithCode(DelegateMethods.CharacterPreview.CompanionCubePet));
		...
		public static int[] StormTigerIds = new int[3] { 833, 834, 835 };
		...
		public static SettingsForCharacterPreview SimpleLoop(int startFrame, int frameCount, int delayPerFrame = 4, bool bounceLoop = false)
		{
			...
			SettingsForCharacterPreview settingsForCharacterPreview = new SettingsForCharacterPreview();
			settingsForCharacterPreview.Offset = Vector2.Zero;
			settingsForCharacterPreview.SpriteDirection = 1;
			settingsForCharacterPreview.WhenSelected(startFrame, frameCount, delayPerFrame, bounceLoop);
			settingsForCharacterPreview.WhenNotSelected(startFrame, frameCount, delayPerFrame, bounceLoop);
			return settingsForCharacterPreview;
		}
	}
